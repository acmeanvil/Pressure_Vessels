...
def test_convert_to_material():
    ...
    assert matl_conv.label=="6061-t6"
...
def test_generate_matl_index():
    matl_list=[]
    matl_1=mt.material(label="test_6061", matl_type="test_Aluminum", matl_cat="test_metal_1")
    matl_list.append(matl_1)
    matl_list.append(mt.material(label="test_7075", matl_type="test_Aluminum", matl_cat="test_metal_1"))   
    matl_list.append(mt.material(label="test_4140", matl_type="test_Steel", matl_cat="test_metal_2"))
    matl_list.append(mt.material(label="test_316", matl_type="test_Stainless Steel", matl_cat="test_metal_3"))
    matl_list.append(mt.material(label="test_316", matl_type="test_Stainless Steel", matl_cat="test_metal_4"))
...
def test_generate_matl_type_index():
    matl_list=[]
    matl_list.append(mt.material(label="test_6061", matl_type="test_Aluminum", matl_cat="test_metal_1"))
    matl_list.append(mt.material(label="test_7075", matl_type="test_Aluminum", matl_cat="test_metal_1"))   
    matl_list.append(mt.material(label="test_4140", matl_type="test_Steel", matl_cat="test_metal_2"))
    matl_list.append(mt.material(label="test_316", matl_type="test_Stainless Steel", matl_cat="test_metal_3"))
    matl_list.append(mt.material(label="test_316", matl_type="test_Stainless Steel", matl_cat="test_metal_4"))
    
    assert mt.generate_matl_type_index(matl_list)==["test_metal_1","test_metal_2","test_metal_3","test_metal_4"]