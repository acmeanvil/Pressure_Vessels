...
def test_thin_hoop_stress():
    ...
    assert epv.thin_hoop_stress(vessel_1, pressure)==1250.0
    assert epv.thin_hoop_stress(vessel_2, pressure)==2250.0
...
def test_thin_longitudinal_stress():
    ...
    assert epv.thin_longitudinal_stress(vessel_1, pressure)==2500.0
    assert epv.thin_longitudinal_stress(vessel_2, pressure)==4500.0
...
def test_thin_diameter_reduction():
    ...
    assert epv.thin_diameter_reduction(vessel_1, pressure)==0.0010625 
    assert epv.thin_diameter_reduction(vessel_2, pressure)==0.01377
...
def test_thin_length_reduction():
    ...
    assert epv.thin_length_reduction(vessel_1, pressure)==0.0005
